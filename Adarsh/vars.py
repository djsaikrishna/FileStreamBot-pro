...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '74.208.236.225'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', 'tmaadda.info')) if not ON_HEROKU or getenv('FQDN','tmaadda.info') else APP_NAME+'.herokuapp.com'
